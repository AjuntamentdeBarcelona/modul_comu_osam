...
```groovy
implementation 'com.github.AjuntamentdeBarcelona:modul_comu_osam:2.1.4'
```
...
```
pod 'OSAMCommon', :git => 'https://github.com/AjuntamentdeBarcelona/modul_comu_osam.git', :tag => '2.1.4'
```
