...
```
implementation 'com.github.AjuntamentdeBarcelona:modul_comu_osam:1.0.9'
```
...
```
pod 'OSAMCommon', :git => 'https://github.com/AjuntamentdeBarcelona/modul_comu_osam.git', :tag => '1.0.9'
```
