...
```groovy
implementation 'com.github.AjuntamentdeBarcelona.modul_comu_osam:common-android:3.0.0'
```
...
```pod
pod 'OSAMCommon', :git => 'https://github.com/AjuntamentdeBarcelona/modul_comu_osam.git', :tag => '3.0.0'
```
