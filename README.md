...
```groovy
implementation 'com.github.AjuntamentdeBarcelona.modul_comu_osam:common-android:2.3.1'
```
...
```pod
pod 'OSAMCommon', :git => 'https://github.com/AjuntamentdeBarcelona/modul_comu_osam.git', :tag => '2.3.1'
```
