...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("AppLanguageInformationResponse")))
@interface OSAMCAppLanguageInformationResponse : OSAMCKotlinEnum<OSAMCAppLanguageInformationResponse *>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly) OSAMCAppLanguageInformationResponse *accepted __attribute__((swift_name("accepted")));
@property (class, readonly) OSAMCAppLanguageInformationResponse *error __attribute__((swift_name("error")));
+ (OSAMCKotlinArray<OSAMCAppLanguageInformationResponse *> *)values __attribute__((swift_name("values()")));
@property (class, readonly) NSArray<OSAMCAppLanguageInformationResponse *> *entries __attribute__((swift_name("entries")));
@end
...
- (void)languageInformationF:(void (^)(OSAMCAppLanguageInformationResponse *, OSAMCLanguageInformation * _Nullable))f __attribute__((swift_name("languageInformation(f:)")));
