...
- (void)logNoConnectionAnalyticReason:(NSString *)reason endpoint:(NSString *)endpoint operativeSystem:(NSString *)operativeSystem operativeSystemVersion:(NSString *)operativeSystemVersion operativeAppVersion:(NSString *)operativeAppVersion module:(NSString *)module __attribute__((swift_name("logNoConnectionAnalytic(reason:endpoint:operativeSystem:operativeSystemVersion:operativeAppVersion:module:)")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("InternetNoConnection")))
@interface OSAMCInternetNoConnection : OSAMCKotlinEnum<OSAMCInternetNoConnection *>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly) OSAMCInternetNoConnection *airplaneMode __attribute__((swift_name("airplaneMode")));
@property (class, readonly) OSAMCInternetNoConnection *noWifi __attribute__((swift_name("noWifi")));
+ (OSAMCKotlinArray<OSAMCInternetNoConnection *> *)values __attribute__((swift_name("values()")));
@property (class, readonly) NSArray<OSAMCInternetNoConnection *> *entries __attribute__((swift_name("entries")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ModelRuleEnum")))
@interface OSAMCModelRuleEnum : OSAMCKotlinEnum<OSAMCModelRuleEnum *>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly) OSAMCModelRuleEnum *allModels __attribute__((swift_name("allModels")));
@property (class, readonly) OSAMCModelRuleEnum *onlyTheseModels __attribute__((swift_name("onlyTheseModels")));
@property (class, readonly) OSAMCModelRuleEnum *notTheseModels __attribute__((swift_name("notTheseModels")));
+ (OSAMCKotlinArray<OSAMCModelRuleEnum *> *)values __attribute__((swift_name("values()")));
@property (class, readonly) NSArray<OSAMCModelRuleEnum *> *entries __attribute__((swift_name("entries")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("OperativeSystemRuleEnum")))
@interface OSAMCOperativeSystemRuleEnum : OSAMCKotlinEnum<OSAMCOperativeSystemRuleEnum *>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly) OSAMCOperativeSystemRuleEnum *allVersions __attribute__((swift_name("allVersions")));
@property (class, readonly) OSAMCOperativeSystemRuleEnum *lessOrEqualThanVersion __attribute__((swift_name("lessOrEqualThanVersion")));
@property (class, readonly) OSAMCOperativeSystemRuleEnum *biggerOrEqualThanVersion __attribute__((swift_name("biggerOrEqualThanVersion")));
@property (class, readonly) OSAMCOperativeSystemRuleEnum *onlyThisVersion __attribute__((swift_name("onlyThisVersion")));
+ (OSAMCKotlinArray<OSAMCOperativeSystemRuleEnum *> *)values __attribute__((swift_name("values()")));
@property (class, readonly) NSArray<OSAMCOperativeSystemRuleEnum *> *entries __attribute__((swift_name("entries")));
@end
...
@interface OSAMCHelpersKt : OSAMCBase
+ (int32_t)compareVersionsV1:(NSString *)v1 v2:(NSString *)v2 __attribute__((swift_name("compareVersions(v1:v2:)")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ModelsDataKt")))
@interface OSAMCModelsDataKt : OSAMCBase
+ (OSAMCModelRuleEnum *)toModelRuleEnum:(int32_t)receiver __attribute__((swift_name("toModelRuleEnum(_:)")));
+ (OSAMCOperativeSystemRuleEnum *)toOperativeSystemRuleEnum:(int32_t)receiver __attribute__((swift_name("toOperativeSystemRuleEnum(_:)")));
@end
